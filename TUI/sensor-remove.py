    ...
    while True:
        ...
        if "SENSOR PIN" in line:
            ...
            while True:
                ...
                # If the line contains the sensor name and pin then remove the line.
                if OUTPUT["Sensor:"] in line and OUTPUT["Pin:"] in line:
                    break
        ...
        if "SENSOR ARRAY" in line:
            ...
            while True:
                ...
                if OUTPUT["Sensor:"] in line:
                    if num == 0:
                        line = "// float " + OUTPUT["Sensor:"] + "[] = {0};\n"
                        finalFile.append(line)
                        break
                    line = "float " + OUTPUT["Sensor:"] + "[" + str(num) + "]" + " = {0};\n"
                    finalFile.append(line)
                    break
...
with ptg.WindowManager() as manager:
    window = (
        ...
        .set_title("[210 bold]Remove Sensor")
        .center()
    )
